        ...
        <div className="homeworkbody">
            <div className=' bg-warning p-2 fs-2 text-center fw-bold rounded-4 mb-3'>Home work Section</div>
            {
               homework.map(work => <div className='alert alert-danger rounded-4'>
                <b className='d-flex justify-content-between '><span className='bi-book bg-light p-2 me-2 rounded-3'> class:{work.class}/section:{work.section} (homework)</span> <span><span className='bi-trash-fill bg-light p-2 rounded-3' title='Delete'></span> <span className='bi-plus-circle-dotted bg-light p-2 rounded-3 ms-1' title='update'></span></span></b>
                <hr />
                <dl>
                    <dt>{work.Subject}</dt>
                    <dd>{work.topic}</dd>
